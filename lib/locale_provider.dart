...
const Map<String, Map<String, String>> _translations = {
  'en': {
    ...
    'needHelp': 'Need Help? 🎓',
    'contactSupport': 'Contact EduSphere support',
    ...
    'systemSync': 'Sync with System',
    // Attendance
    'qrAttendance': 'QR Attendance',
    'smartAttendance': 'EduSphere Smart Attendance System',
    'scanQr': 'Scan QR Code',
    // Search
  ...
  'ar': {
    ...
    'contactSupport': 'تواصل مع دعم EduSphere',
    'getSupport': 'الحصول على الدعم',
    'welcomeBack': 'مرحباً بعودتك،',
    'welcomeName': 'روضة أيمن! 👋',
    'welcomeSub': 'إليك ما يحدث في دراستك اليوم.',
    ...
    'pendingAssignments': 'التكاليف المعلقة',
    'viewAll': 'عرض الكل',
    ...
    'smartAttendance': 'نظام الحضور الذكي من EduSphere',
    'scanQr': 'مسح الرمز',
  ...
  'ru': {
    ...
    'contactSupport': 'Свяжитесь с поддержкой EduSphere',
    'getSupport': 'Получить Помощь',
    'welcomeBack': 'С возвращением,',
    'welcomeName': 'Равда Айман! 👋',
    'welcomeSub': 'Вот что сегодня происходит с вашей учебой.',
    ...
    'pendingAssignments': 'Ожидающие Задания',
    ...
    'systemSync': 'Синхр. с Системой',
    'qrAttendance': 'QR Посещаемость',
    'smartAttendance': 'Система смарт-посещаемости EduSphere',
  ...
  'fr': {
    ...
    'contactSupport': 'Contacter le support EduSphere',
    'getSupport': "Obtenir de l'aide",
    'welcomeBack': 'Bon retour,',
    'welcomeName': 'Toka Khaled! 👋',
    'welcomeSub': "Voici ce qui se passe avec vos études aujourd'hui.",
    ...
    'settingsSub': 'Gérer votre compte et vos préférences',
    'profile': 'Profil',
    'security': 'Sécurité',
    'notifications': 'Notifications',
    ...
    'smartAttendance': "Système de présence intelligente d'EduSphere",
    'scanQr': 'Scanner QR',
  ...
  'de': {
    ...
    'contactSupport': 'EduSphere Support kontaktieren',
    'getSupport': 'Hilfe erhalten',
    'welcomeBack': 'Willkommen zurück,',
    'welcomeName': 'Toka Khaled! 👋',
    'welcomeSub': 'Was heute in deinem Studium passiert.',
    ...
    'pendingAssignments': 'Offene Aufgaben',
    ...
    'systemSync': 'Systemsynchronisierung',
    'qrAttendance': 'QR-Anwesenheit',
    'smartAttendance': 'EduSphere Smart-Anwesenheitssystem',
    'scanQr': 'QR scannen',
